...
from rag_project.api.routes import query_routes, user_routes, password_routes, workspace_routes, topic_generation_routes
...
app.include_router(topic_generation_routes.router, prefix="/topic_generation",tags=['Topic_Generation'])